      ...
      <Image backgroundImage="https://mdbootstrap.com/img/Photos/Others/images/91.jpg">
        ...
        <Container id="aboutbox">
          ...
          <p>
            ...
            Riverside. I have studied and excelled in multiple coding languages:
            <ul>
              <li>HTML</li>
              <li>CSS</li>
              <li>JavaScript</li>
            ...
            Bachelors degree in Environmental Geography and a Associates degree
            in Math and Sciences from Riverside City College, I am ready to
            challenge any tasks at hand. With a strong work ethic that I have
            displayed throughout past and present employers, I can present and
            resolve tasks that a employer needs with confidence.
          </p>
        </Container>
      </Image>
    </div>
